    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{route('product.index')}}" class="nav-link @if($route_prefix == 'article') active @endif">
          ...
          <li class="nav-item">
            <a href="{{route('user.index')}}" class="nav-link @if($route_prefix == 'user') active @endif">
