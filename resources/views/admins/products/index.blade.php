                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <img src="{{asset($product->thumbnail)}}" alt="Thumbnail" width="50">
                            </td>
                            <td>{{$product->name}}</td>
                            ...
                            <td>
                                ...
                                <a href="{{route('product.delete', $product->id)}}" onclick="return confirm('Are you OK?')" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
